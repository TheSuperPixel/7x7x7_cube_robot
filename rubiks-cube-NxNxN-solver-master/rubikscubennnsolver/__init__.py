...
class RubiksCube(object):
    ...
    def print_solution(self, include_comments: bool) -> None:
        ...
        # print(f"my_Solution is {' '.join(solution_minus_comments)}")
        with open('/home/pi/Desktop/cube_project/cube_robot_7x7x7-master/my_solution/my_solution.txt', 'w') as f:#还原魔方的步骤
            f.write(str(' '.join(solution_minus_comments)))
